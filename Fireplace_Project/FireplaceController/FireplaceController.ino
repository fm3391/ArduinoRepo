...
/**
   Pin Declarations
*/
byte MD10C_DIR_PIN = 0;
byte MD10C_PWM_PIN = 0;
byte MD10C_MOSFET_PIN = 0;
byte THERMOSTAT_PIN = 0;
byte CHARGECONTROLLER_RELAY_PIN = 0;
byte CHARGECONTROLLER_INPUT_PIN = 0;
byte OVERRIDE_ON_PIN = 0;
byte OVERRIDE_OFF_PIN = 0;
byte ACTIVITYMONITOR_INPUT_PIN = 0;
